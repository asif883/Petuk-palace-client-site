        ...
        {!loading && role !== 'admin' && (
          <div className='flex items-center justify-center min-h-screen'>
            <h1 className='text-red-600 font-semibold text-2xl'>
              Only Admin Can Access Pending Orders
            </h1>
          </div>
        )}

        {/* Step 3: Show "No pending orders" */}
        {!loading && role === 'admin' && orders.length === 0 && (
            ...
            {orders.map((order, index) => (
              ...
              >
                <div className="flex justify-between items-start mb-4 flex-wrap gap-2">
                  ...
                  <div className="text-right text-sm text-gray-600">
                    <p className="font-medium text-gray-700">
                      User: <span className="text-blue-600">{order?.userEmail}</span>
                    </p>
                    <p>
                      Order ID:{' '}
                ...
                <div className="text-right mt-4 flex justify-between items-center">
                  ...
                  <button className="bg-gray-700 text-white px-4 py-2 rounded hover:bg-gray-900 transition cursor-pointer">
                    Mark as Success
                  </button>
                </div>
              </div>
